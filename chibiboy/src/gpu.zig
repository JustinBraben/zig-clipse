...
pub const GPU = struct {
    ...
    hw_window: ?*SDL.SDL_Window,
    hw_buffer: ?*SDL.SDL_Texture,
    hw_renderer: ?*SDL.SDL_Renderer,
    buffer: ?*SDL.SDL_Surface,
    sw_renderer: ?*SDL.SDL_Renderer,
    colors: [4]SDL.SDL_Color,
    bgp: [4]SDL.SDL_Color,
    ...
    pub fn new(cpu: *CPU, name: []const u8, headless: bool, debug: bool) !GPU {
        ...
        var hw_window: ?*SDL.SDL_Window = null;
        ...
        // Colors
        const colors: [4]SDL.SDL_Color = .{
            SDL.SDL_Color{ .r = 0x9B, .g = 0xBC, .b = 0x0F, .a = 0xFF },
            SDL.SDL_Color{ .r = 0x8B, .g = 0xAC, .b = 0x0F, .a = 0xFF },
            SDL.SDL_Color{ .r = 0x30, .g = 0x62, .b = 0x30, .a = 0xFF },
            SDL.SDL_Color{ .r = 0x0F, .g = 0x38, .b = 0x0F, .a = 0xFF },
        };
    ...
    pub fn tick(self: *GPU) !void {
        ...
        if (lx == 0 and ly < 144) {
            ...
            if (ly == 0) {
                ...
                _ = SDL.SDL_RenderClear(self.sw_renderer);
    ...
    fn draw_debug(self: *GPU) !void {
        ...
        var tile_id: u15 = 0;
        while (tile_id < 384) {
            var xy = SDL.SDL_Point{
                .x = 160 + (tile_id % tile_display_width) * 8,
                .y = (tile_id / tile_display_width) * 8,
            };
            try self.paint_tile(@intCast(tile_id), &xy, self.bgp, false, false);
            tile_id += 1;
        }
    ...
    fn draw_line(self: *GPU, ly: u16) !void {
        ...
        if (lcdc & LCDC.BG_WIN_ENABLED != 0) {
            ...
            const tile_sub_y: u3 = @intCast(y_in_bgmap % 8);
    ...
    fn paint_tile(self: *GPU, tile_id: i16, offset: *SDL.SDL_Point, palette: [4]SDL.SDL_Color, flip_x: bool, flip_y: bool) !void {
        var y: u3 = 0;
        while (true) {
    ...
    fn paint_tile_line(
        self: *GPU,
        tile_id: i16,
        offset: *SDL.SDL_Point,
        palette: [4]SDL.SDL_Color,
        flip_x: bool,
        flip_y: bool,
        y: u3,
    ) !void {
...
pub fn gen_hue(n: u8) SDL.SDL_Color {
    ...
    return switch (region) {
        0 => SDL.SDL_Color{ .r = 255, .g = t, .b = 0, .a = 0xFF },
        1 => SDL.SDL_Color{ .r = q, .g = 255, .b = 0, .a = 0xFF },
        2 => SDL.SDL_Color{ .r = 0, .g = 255, .b = t, .a = 0xFF },
        3 => SDL.SDL_Color{ .r = 0, .g = q, .b = 255, .a = 0xFF },
